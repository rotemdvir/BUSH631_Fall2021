...
# (1) Create data: a vector of top-5 NFL week 1 winners points and the Dolphins
v_win <- c(41,38,37,34,33,17)

# (2) Calculate sample mean
mean(v_win)

# (3) Create vector of difference of each data point from mean
v_diff <- (v_win - mean(v_win))

# (4) Square each resulting differnece
v_diff_sq <- (v_diff)^2

# (5) Final SD steps: square root of sum of squared differences 
